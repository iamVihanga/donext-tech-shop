...
// Order Status History Schema with date transformations
export const orderStatusHistorySchema = createSelectSchema(
  orderStatusHistory
).extend({
  createdAt: z.date().transform((date) => date && date.toISOString()),
  updatedAt: z
...
export const orderWithItemsSchema = orderSchema.extend({
  ...
  statusHistory: z.array(orderStatusHistorySchema).optional() // Use the transformed schema
});
